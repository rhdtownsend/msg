...
files created for selected systems in the SVO database using the
:command:`make_passband` tool. For each filter of each system,
separate passband files for the Vega, AB and ST magnitude systems are
provided.
